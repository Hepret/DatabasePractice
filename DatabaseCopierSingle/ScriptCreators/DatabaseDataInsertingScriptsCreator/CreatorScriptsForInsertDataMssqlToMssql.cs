...
{ 
    public class CreatorScriptsForInsertDataMssqlToMssql : ICreateInsertDataScripts
    {
        ...
        private string CreateRowToInsertString(TableDataRow row, SchemaTable table)
        {
            ...
            {
                if (table.Columns[i].IsGenerated == "1") continue;
        ...
        private string CreateItemString(object item, SchemaColumn columnInfo)
        {
            ...
            switch (columnInfo.DataType)
            {
                ...
                case "bit":
                    return bool.Parse(item.ToString()) == true ? "1" : "0";
